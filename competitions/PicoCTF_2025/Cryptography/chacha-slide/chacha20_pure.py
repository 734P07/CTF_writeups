...
class ChaCha(object):
    ...
    def encrypt(self, plaintext):
        ...
        for i, block in enumerate(plaintext[i:i+64] for i
            ...
            print(f"key stream {i}:", key_stream.hex())
...
a = ChaCha(b"a"*32, b"b"*12)
print(a.encrypt(b"Did you know that ChaCha20-Poly1305 is an authenticated encryption algorithm?").hex())